	...
	//! To enable the debug layers using this API, it must be called before the D3D12 device is created.
{
	...
	// Prefer the first adapter (typically discrete GPU).
	HRESULT hardwareResult = D3D12CreateDevice(
		adapterList[0], // use NVIDIA/AMD adapter if available
		D3D_FEATURE_LEVEL_11_0, // use 11.0 for maximum compatibility
	...
	if (md3dDevice == nullptr)
	{
		OutputDebugString(L"FATAL: md3dDevice is still NULL after InitDirect3D.\n");
		return false;
	}
